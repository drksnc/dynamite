...
namespace RawInput {
	...
	void TestAction(BUTTONEVENT buttonEvent) {
		spdlog::debug("ButtonEvent: {:d}, Action: TestAction", static_cast<uint32_t>(buttonEvent));
	...
	void ToggleUI(RawInput::BUTTONEVENT buttonEvent) {
                    spdlog::debug("ButtonEvent: {:d}, Action: ToggleUI", static_cast<uint32_t>(buttonEvent));
	...
	void ToggleCursor(RawInput::BUTTONEVENT buttonEvent) {
		spdlog::debug("ButtonEvent: {:d}, Action: ToggleCursor", static_cast<uint32_t>(buttonEvent));
		if (buttonEvent == RawInput::BUTTONEVENT::ONDOWN) {
	...
	void ToggleImguiDemo(RawInput::BUTTONEVENT buttonEvent) {
		spdlog::debug("ButtonEvent: {:d}, Action: ToggleImguiDemo", static_cast<uint32_t>(buttonEvent));
		if (buttonEvent == RawInput::BUTTONEVENT::ONDOWN) {
	...
	void ToggleStyleEditor(RawInput::BUTTONEVENT buttonEvent) {
		spdlog::debug("ButtonEvent: {:d}, Action: ToggleStyleEditor", static_cast<uint32_t>(buttonEvent));
		if (buttonEvent == RawInput::BUTTONEVENT::ONDOWN) {
